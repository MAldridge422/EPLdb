...
def managers():
    ...
    managers_data = [
      ...
      [21, "Craig Shakespeare", None, None],
      [22, "Tony Pulis", None, None],
      [23, "Ronald Koeman", None, None],
      [24, "Frank De Boer", None, None],
      [25, "Slaven Bilic", None, None],
    ]
